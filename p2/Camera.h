...
Camera::updateViewMatrix() {
	this->_matrix = mat4f::lookAt(position(), focalPoint(), vec3f::up()); // Faltou o VUP
}


inline void
Camera::updatePerspectiveProjectionMatrix() {
	this->_projectionMatrix = mat4f::perspective(viewAngle(),aspectRatio(), _B, _F);
}
...
Camera::updateInverseMatrix() {
	// TODO
	//this->_inverseMatrix = mat4f::inverse(this._matrix);
}
